...
public class AnglerFormPower extends AbstractAdventurerPower {
    ...
    public void updateDescription() {
        description = powerStrings.DESCRIPTIONS[0] + amount + powerStrings.DESCRIPTIONS[1] + Math.max(0, amount - AbstractDungeon.actionManager.cardsPlayedThisTurn.size()) + powerStrings.DESCRIPTIONS[2];
    }
}