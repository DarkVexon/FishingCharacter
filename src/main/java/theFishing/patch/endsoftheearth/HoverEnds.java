...
public class HoverEnds {
    ...
    public static void GetHoverOtherHand(AbstractPlayer __instance) {
        if (__instance.hoveredCard == null) {
            for (AbstractCard top : TrackEnds.Fields.currentCard.get(AbstractDungeon.player.discardPile)) {
                if (top != null) {
                    top.hb.update();
                    if (top.hb.hovered) {
    ...
    public static void reposition(AbstractPlayer __instance) {
        if (TrackEnds.Fields.currentCard.get(AbstractDungeon.player.discardPile).contains(__instance.hoveredCard)) {
