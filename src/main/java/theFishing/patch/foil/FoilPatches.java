...
//    }
    ...
    @SpirePatch(clz = AbstractCard.class, method = "renderPowerBg")
    ...
    @SpirePatch(clz = AbstractDungeon.class, method = "transformCard", paramtypez = {AbstractCard.class, boolean.class, Random.class})
