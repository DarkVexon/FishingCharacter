            ...
            atb(new AbstractGameAction() {
                ...
                public void update() {
                    ...
                    if (q != null) {
                        ...
                        att(new VFXAction(new ColoredVerticalAttackEffect(q.hb.cX - 60F * Settings.scale, q.hb.cY, true, new Color(MathUtils.random(), MathUtils.random(), MathUtils.random(), 1))));
                    }
                }
            });
        }
