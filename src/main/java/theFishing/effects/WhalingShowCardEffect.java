...
public class WhalingShowCardEffect extends AbstractGameEffect {
    ...
    public WhalingShowCardEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset, boolean toBottom) {
    ...
    public WhalingShowCardEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset) {
        this(srcCard, x, y, randomSpot, cardOffset, false);
    }

    public WhalingShowCardEffect(AbstractCard srcCard, float x, float y, boolean randomSpot) {
        this(srcCard, x, y, randomSpot, false);
    }

    public WhalingShowCardEffect(AbstractCard srcCard, boolean randomSpot, boolean toBottom) {
        this.randomSpot = false;
        this.cardOffset = false;
    ...
    private void identifySpawnLocation(float x, float y) {
        ...
        while(var4.hasNext()) {
            ...
            if (e instanceof WhalingShowCardEffect) {
                ++effectCount;
            }
        }
