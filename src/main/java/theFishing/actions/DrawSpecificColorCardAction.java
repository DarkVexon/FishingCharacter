...
public class DrawSpecificColorCardAction extends AbstractGameAction {
    private AbstractPlayer p;
    private AbstractCard.CardColor colorMatch;

    public DrawSpecificColorCardAction(int amount, AbstractCard.CardColor color) {
